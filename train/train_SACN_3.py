...
from model import Network_SACN_3 as Network
...
parser = argparse.ArgumentParser(description="SACN_3 train model")
...
parser.add_argument('--arch', type=str, default='SACN_3',
