...
from model_search import SACN_3
from architect import Architect_SACN_3

parser = argparse.ArgumentParser(description="SACN_3 search model")
...
parser.add_argument('--stage', type=int, default=3, help='train SACN stage')
