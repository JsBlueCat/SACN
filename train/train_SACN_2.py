...
from model import Network_SACN_2 as Network
...
parser = argparse.ArgumentParser(description="SACN_2 train model")
...
parser.add_argument('--init_channels', type=int,
                    default=24, help='num of init channels')
...
parser.add_argument('--cutout_length', type=int,
                    default=24, help='cutout length')
parser.add_argument('--drop_path_prob', type=float,
                    default=0.2, help='drop path probability')
parser.add_argument('--save', type=str, default='EXP', help='experiment name')
parser.add_argument('--seed', type=int, default=0, help='random seed')
parser.add_argument('--arch', type=str, default='SACN_2',
                    help='which architecture to use')
parser.add_argument('--grad_clip', type=float,
                    default=5, help='gradient clipping')
parser.add_argument('--stage', type=int, default=2, help='train SACN stage')
